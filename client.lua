local kamienpapiernozyce = 1
RegisterNetEvent('lvkees_kpn:pokaz3d')
AddEventHandler('lvkees_kpn:pokaz3d', function(tekst, source)
    local zmienna = 1 + (kamienpapiernozyce*0.15)
...
function Pokazuj(osoba, tekst, zmienna)
    ...
    Citizen.CreateThread(function()
        kamienpapiernozyce = kamienpapiernozyce + 1
        while pokazuje do
            Wait(0)
